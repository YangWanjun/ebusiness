...
select m.id
  ...
  join eb_membersectionperiod msp1 on msp1.is_deleted = 0
                                   ...
                                   and (msp1.end_date is null or msp1.end_date >= in_base_date)
  ...
  left join eb_bp_contract bp_c on bp_c.is_deleted = 0
                               ...
                               and (bp_c.end_date is null or bp_c.end_date >= in_base_date)
  ...
  left join eb_membersalespersonperiod msp2 on msp2.is_deleted = 0
                                           ...
                                           and (msp2.end_date is null or msp2.end_date >= in_base_date)
  ...
  left join eb_membersalesoffperiod msp3 on msp3.is_deleted = 0
                                        ...
                                        and (msp3.end_date is null or msp3.end_date >= in_base_date)
