...
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 104.v_turnover_customers_by_month.sql
...
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 300.sp_search_member.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 301.sp_member_brief_status.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 302.sp_member_working_status.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 303.sp_partner_working_status.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 311.sp_member_list.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 312.sp_project_dashboard.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 313.sp_organization_dashboard.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 314.sp_salesperson_history.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 315.sp_organization_list.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 316.sp_organization_members.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 317.sp_partner_list.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 318.sp_partner_monthly_status.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 319.sp_partner_members.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 320.sp_partner_member_orders.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 321.sp_partner_lump_orders.sql
mysql -h 192.168.99.100 -u root -proot --default-character-set=utf8 eb_sales < 322.sp_partner_contracts_by_month.sql
