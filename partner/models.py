...
from utils.models import AbstractCompany, AbstractMember, BaseModel
...
class PartnerPayNotifyRecipient(BaseModel):
    ...
    member = models.ForeignKey(
        PartnerMember, db_column='subcontractor_member_id', on_delete=models.PROTECT, verbose_name="所属会社社員",
    )
